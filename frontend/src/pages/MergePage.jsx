...
const MergePage = () => {
  ...
  const handleMerge = async () => {
    ...
    try {
      ...
      addToast(
        error.response?.data?.message || error.message || 'Failed to merge PDFs',
        'error'
      );
    } finally {
      setLoading(false);
    ...
    <div className="operation-page">
      ...
      <header className="operation-header">
        ...
        <p className="operation-description">
          Combine multiple PDF files into a single document. Drag to reorder files.
        </p>
      </header>
                  ...
                  {files.map((file, index) => (
                    ...
                    >
                      ...
                      <div className="file-order-actions">
                        ...
                        <button
                          className="file-order-btn delete"
        ...
        <main className="operation-preview">
          {files.length > 0 && files[selectedFileIndex] ? (
            <>
              ...
              <PdfViewer file={files[selectedFileIndex]} showThumbnails={true} />
            </>
          ) : (
